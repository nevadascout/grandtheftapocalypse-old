// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WorldHelper.cs" company="nevada_scout">
...
namespace GrandTheftApocalypse.Story.Internal
{
    ...
    {
        private readonly Main mainScript;

        public WorldHelper(Main mainScript)
        {
            this.mainScript = mainScript;
        }

        /// <summary>
        /// Create a prop at a specified location
        /// </summary>
        public void CreatePropAtPosition(string propName, Vector3 position)
        {
            ...
            if (model.IsInCdImage && model.IsValid)
            {
                ...
                World.CreateProp(model, position, true, true);
        ...
        /// </summary>
        public void CreatePropInFrontOfPlayer(string propName)
        {
            Logger.Log("Trying to spawn prop '" + propName + "'");
        ...
        /// </summary>
        public Vehicle CreateDrivableVehicle(VehicleHash vehicleHash, Vector3 position, Color color, float heading = 0)
        {
        ...
        /// </summary>
        public void SetPlayerModel(PedHash pedHash)
        {
